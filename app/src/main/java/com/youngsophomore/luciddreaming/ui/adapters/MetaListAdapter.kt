...
class MetaListAdapter : RecyclerView.Adapter<MetaListAdapter.ViewHolder>() {
    private var allMetaItems = emptyList<String>()
    class ViewHolder(val binding: ItemMetaBinding) : RecyclerView.ViewHolder(binding.root)
